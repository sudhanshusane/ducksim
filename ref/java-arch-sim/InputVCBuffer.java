 ...
 * as many buffer objects as many virtual channels are required. InputVCBuffer
...
public class InputVCBuffer {
	 ...
	 * 
	 * @param vcCount
	 *            Number of virtual channel for the input physical link.
	 * @param linkNo
	 *            Physical link no.
	 */
	 ...
	 * method is called by an Input Link Controller. Everytime a flit enters the
	 ...
	 *            Flit data
	 * @param vcId
	 *            Virtual Channel no. to which this flit has to be delegated
	 * @param curCycle
	 *            Current timestamp
	 ...
	 * The method is called by an Input Link Controller. The flit can be removed
	 * if it is stored there at least one cycle ahead of the current timestamp
	 * specified by 'curCycle'.
	 * 
	 * @param vcId
	 *            Virtual channel number from where the flit is to be removed
	 * @param curCycle
	 *            Current timestamp
