...
public class Controller {
	...
	public void main_loop() {
		...
		while (toGo) {
			...
			//I add this 
			int u = 0; double out_rate = 0.0; 
			for (u = 0; u < IConstants.NUMBER_OF_IP_NODE; u++) 
			out_rate +=  ((IConstants.SOURCE_SSSS[u]/IConstants.SOURCE_MSGS[u]) - 1); 		
			out_rate /= IConstants.NUMBER_OF_IP_NODE;
			...
			try {
				...
				Str += "  Avg Msg Length(bytes)\t"
						+ IConstants.AVG_MESSAGE_LENGTH + "\n";
				Str += "  Flit Length(bits)\t" + IConstants.FLIT_LENGTH + "\n";
				...
				Str += "\n  ==== APPLICATION: "+ IConstants.APP_FILE;
				Str += "\n  ==============================================================";
				if (IConstants.ALGORITHM == 0) Str += "\n  DOR-YX routing used";
				if (IConstants.ALGORITHM == 1) Str += "\n  DOR-XY routing used";
				if (IConstants.ALGORITHM == 2) Str += "\n  DJK_CDG routing used";
				if (IConstants.ALGORITHM == 3) Str += "\n  ILP routing used";
				if (IConstants.ALGORITHM == 4) Str += "\n  ROMM routing used";
				if (IConstants.ALGORITHM == 5) Str += "\n  VALIANT routing used";
				Str += "\n  ==============================================================";
				...
				Str += "\n  ==============================================================";
				Str += "\n  Demand average Rate (DAR): "+ IConstants.RATE[0];
				Str += "\n  Actual average Rate (AAR): "+ out_rate;
				Str += "\n  Throughput (DAR/AAR): "+ IConstants.RATE[0]/out_rate;
				Str += "\n  ==============================================================";
				Str += "\n\n\n";
		...
		for (u = 0; u < IConstants.NUMBER_OF_IP_NODE; u++) {
			out_rate +=  ((IConstants.SOURCE_SSSS[u]/IConstants.SOURCE_MSGS[u]) - 1); 
			//System.out.println("Node :"+ u +" rate: "+ ((IConstants.SOURCE_SSSS[u]/IConstants.SOURCE_MSGS[u])- 1));
			}		
		//System.out.println("Total rate :"+ out_rate);
		out_rate /= IConstants.NUMBER_OF_IP_NODE;
		System.out.println("Demand average Rate: "+ IConstants.RATE[0]);
		System.out.println("Actual average Rate: "+ out_rate);
		System.out.println("Throughput (Demand average Rate / Actual average Rate): "+ IConstants.RATE[0]/out_rate);
