/**
 * <p>
 * The FatTreeRouter class is the implementation of the Router interface for the
...
public class FatTreeRouter implements Router {
	 ...
	 * considering range of IP nodes covered by this switch.
	 * </p>
	 * 
	 * <p>
	 * <ul>
	 ...
	 * IConstants.FAT_NUM_INDEX_BIT</i></li>
	 * <li>?Calculates index of the switch in this level by <i>sIndex =
	 * switchAddr & ( (1 << IConstants.FAT_NUM_INDEX_BIT) - 1) </i></li>
	 * <li>Calculates the range of IP nodes covered by (descendent of this
