...
public class OutputVCBuffer {
	 ...
	 * 
	 * @param vcCount
	 *            Number of virtual channel for the output physical link.
	 * @param linkNo
	 *            Physical link no.
	 */
	 ...
	 * method is called by an Input Link Controller. Everytime a flit needs to
	 ...
	 * @return a free output channel if available, -1 otherwise
	 */
	public int getFreeVC_NEW(Flit f, int node) {
		int i = f.VCs[node];
