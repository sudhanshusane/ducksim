...
public class Flit {
	 ...
	 */
	public int getType() {
		int temp = this.data[0] & ((1 << IConstants.NUM_FLIT_TYPE_BITS) - 1);
	...
	public int getVirtualChannelNo() {
		if (null == data) {
			System.out.println("getVirtualChannelNo(): -1");
			return -1;
		}
		int temp = (data[0] >> IConstants.NUM_FLIT_TYPE_BITS)
				& ((1 << IConstants.NUM_VCID_BITS) - 1);
		System.out.println("getVirtualChannelNo(): " + temp);
		return temp; 
	...
	public void setVirtualChannelNo(int vcId) {
		...
		System.out.println("IConstants.NUM_VCID_BITS: " + IConstants.NUM_VCID_BITS); 
		System.out.println("mask: " + mask); 
		mask <<= IConstants.NUM_FLIT_TYPE_BITS;
		System.out.println("IConstants.NUM_FLIT_TYPE_BITS: " + IConstants.NUM_FLIT_TYPE_BITS); 
		System.out.println("mask: " + mask); 
		mask = ~mask;
		System.out.println("mask: " + mask); 
